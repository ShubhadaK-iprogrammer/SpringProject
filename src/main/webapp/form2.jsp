...
<input type="submit" value="Submit">
	...
	<div class="content">
		...
		<div class="container ">
		 <div> <a href="getBiddingList"> <svg xmlns="http://www.w3.org/2000/svg" width="48" height="32" fill="white" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
			...
			<div class="row align-items-stretch no-gutters contact-wrap mt-5">
				<div class="col-md-8">
                 ...
                 Create BID
									...
									<input type="submit" value="Create BID" name="createBid"
