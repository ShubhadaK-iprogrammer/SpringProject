...
<body>
    <div class="container mt-3 shadow p-3 mb-5 bg-body rounded">
        ...
        <nav class="navbar navbar-dark bg-dark">
            ...
            <button type="button" class="btn btn-danger mr-3"><a href="logout"></a>Log Out</button>
    
        </nav>
    
                  <a href="myBids" class="text-white text-decoration-none"><button
                          class="btn btn-success btn-sm shadow mt-3" data-toggle="modal">
                          Your Raised BIDS</button></a>
                          
                      
                          <c:forEach var="BiddingData" items="${list}">
                  <c:forEach var="bidderData" items="${BiddingData.bidder}">
                      <div class="shadow pb-3" style="overflow-x:auto;">
