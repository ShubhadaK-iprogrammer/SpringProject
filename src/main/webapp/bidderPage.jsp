    ...
    <div class="container mt-3 shadow p-3 mb-5 bg-body rounded">
        ...
        <nav class="navbar navbar-dark bg-dark">
            ...
            <div class="row pt-4 pb-2">
              <div class="col-md-8">
                <a href="myBids" class="text-white text-decoration-none">
                     <button type="button" class="btn btn-success btn-sm">Your Raised Bid</button></a>
                     <a href="acceptedBidderBids"
                     class="text-white text-decoration-none">
                     <button type="button" class="btn btn-primary btn-sm">Your Accepted Bid</button></a>
                    ...
                    <div class="table-title m-0 shadow mb-3 mt-5 ">
                        <div class="row pt-4 pb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <c:choose>
                                    <c:when test="${BiddingData.status=='active'}">
                                
                                        <button class="btn btn-success btn-sm shadow fs-6"
                                            data-toggle="modal">
                                            <b>ACTIVE</b>
                                        </button>
                                                                    <a href="raiseBid/${BiddingData.bidId}"
                                class="text-white text-decoration-none"><button
                                    class="btn btn-success btn-sm shadow fs-6"
                                    data-toggle="modal">
                                    Raise Your BID
                                </button></a>
                                    ...
                                    <c:otherwise>
                                        <button class="btn btn-danger btn-sm shadow fs-6"
                                            data-toggle="modal">
                                            <b>INACTIVE</b>
                                        </button>
                                    </c:otherwise>
